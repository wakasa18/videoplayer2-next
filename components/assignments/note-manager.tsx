...
import { Loader2, Pin, Plus, Trash2 } from "@/components/ui/icons";
...
export function NoteManager({ assignmentId, initialNotes }: { assignmentId: number; initialNotes: AssignmentNote[] }) {
  ...
  async function add(event: FormEvent) {
    ...
    catch (error) { (await showNotice(error instanceof Error ? error.message : "Could not add note.")); } finally { setBusyId(null); }
  }

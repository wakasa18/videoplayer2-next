        ...
        {columns.map(({ status, icon: Icon, accent }, columnIndex) => {
          ...
          return (
            <motion.section
              ...
              className="min-h-[440px] rounded-[24px] border border-[#e1e5ea] bg-[#f8f9fa] p-3"
            >
              <header className="mb-3 flex items-center justify-between gap-3 px-2 py-1">
                <div className="flex items-center gap-2">
                  <span
                    className="grid size-8 place-items-center rounded-xl bg-white shadow-sm"
                    style={{ color: accent }}
                  >
                ...
                <span className="rounded-full bg-white px-2.5 py-1 text-xs font-semibold text-[#5f6368] shadow-sm">
                  {items.length}
                </span>
              </header>
              <div className="space-y-3">
                {items.length > 0 ? (
                  ...
                  <div className="grid min-h-28 place-items-center rounded-[18px] border border-dashed border-[#cbd2d9] bg-white/70 p-4 text-center text-xs leading-5 text-[#80868b]">

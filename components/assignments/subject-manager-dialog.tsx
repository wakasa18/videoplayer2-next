...
export function SubjectManagerDialog({
  ...
  return <AnimatePresence>{open ? (
    <motion.div className="fixed inset-0 z-[100] grid place-items-center bg-[#020611]/75 p-4 backdrop-blur-[2px]" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
      <motion.div className="max-h-[94vh] w-full max-w-5xl overflow-hidden rounded-[28px] border border-white/10 bg-white/[0.045] shadow-2xl" initial={{ opacity: 0, y: 18, scale: .97 }} animate={{ opacity: 1, y: 0, scale: 1 }} exit={{ opacity: 0, y: 10, scale: .98 }}>

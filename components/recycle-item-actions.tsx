...
import { AlertTriangle, Loader2, RotateCcw, Trash2, X } from "@/components/ui/icons";
...
export function RecycleItemActions(props: RecycleItemActionsProps) {
  ...
  async function permanentDelete() {
    ...
    try {
      ...
      router.refresh();
      if (payload.warning) (await showNotice(payload.warning));
    } catch (reason) {

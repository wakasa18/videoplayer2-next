    ...
    <header className="sticky top-0 z-40 border-b border-white/10 bg-[#050a13]/82 backdrop-blur-2xl">
      <div className="mx-auto flex min-h-[4.5rem] max-w-[1720px] items-center gap-3 px-3 sm:px-5 lg:px-6">
        ...
        <div className="flex shrink-0 items-center gap-3">
          <span className="grid size-11 place-items-center rounded-2xl border border-cyan-300/25 bg-[linear-gradient(135deg,rgba(35,211,255,0.95),rgba(78,101,255,0.95))] text-[#04101d] shadow-[0_10px_28px_rgba(40,145,255,0.28)]">
        ...
        <form
          action={searchAction}
          method="get"
          className="mx-auto hidden w-full max-w-2xl items-center gap-3 rounded-2xl border border-white/10 bg-white/[0.045] px-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.03)] transition focus-within:border-cyan-300/35 focus-within:bg-white/[0.065] md:flex"
        >
        ...
        <div className="ml-auto flex items-center gap-2 sm:gap-3">
          ...
          <span
            ...
            className="grid size-10 place-items-center rounded-2xl border border-cyan-200/20 bg-[linear-gradient(135deg,#27d3ff,#526dff)] text-sm font-bold text-[#04101d] shadow-[0_8px_22px_rgba(44,149,255,0.22)]"
          >
            {initial}
          </span>
          <div className="rounded-2xl border border-white/10 bg-white/5 p-1">

...
import { CheckCircle2, Fingerprint, Loader2, ShieldAlert } from "@/components/ui/icons";
...
export function FileIntegrityCard({ fileId, checksum, verifiedAt }: { fileId: number; checksum: string | null; verifiedAt: string | null }) {
  ...
  return (
    <div className="tech-card rounded-2xl border border-white/10 bg-white/[0.035] p-4">
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1">
          ...
          {state.initialized ? <p className="mt-1 text-[11px] text-primary">Baseline initialized from the stored object.</p> : null}

...
import { CalendarDays, CloudOff, Download, File, RefreshCw, Wifi, WifiOff } from "@/components/ui/icons";
...
export default function OfflinePage() {
  ...
  async function openFile(file: OfflineFileRecord, download = false) {
    ...
    if (!url) { await showNotice("This offline copy is no longer available on this device."); return; }
    if (download) {

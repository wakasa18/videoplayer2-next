    ...
    <main className="grid min-h-[65vh] place-items-center">
      <section className="tech-card w-full max-w-xl rounded-[28px] border border-red-300/25 bg-white/[0.045] p-8 text-center shadow-sm">
        ...
        <button
          type="button"
          onClick={reset}
          className="mt-6 inline-flex h-11 items-center justify-center gap-2 rounded-full workspace-primary px-5 text-sm font-semibold text-white transition hover:brightness-110"
        >

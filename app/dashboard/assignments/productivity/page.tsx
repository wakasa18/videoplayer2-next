import { AlertTriangle, BellRing } from "@/components/ui/icons";
  ...
  return (
    <main className="grid min-h-[68vh] place-items-center">
      <section className="tech-card w-full max-w-2xl rounded-[28px] border border-amber-300/25 bg-white/[0.045] p-5 shadow-sm sm:p-9">
        ...
        <p className="mt-5 text-xs font-bold uppercase tracking-[.08em] text-slate-400">Productivity setup</p>
        <h1 className="mt-2 text-2xl font-semibold text-slate-100">Productivity tools need database setup</h1>

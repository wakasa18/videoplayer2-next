  ...
  return (
    <main className="grid min-h-[68vh] place-items-center">
      <section className="w-full max-w-2xl rounded-[28px] border border-[#f2d6a1] bg-white p-7 shadow-sm sm:p-9">
        ...
        <p className="mt-5 text-xs font-bold uppercase tracking-[.08em] text-[#80868b]">Phase 5C</p>
        <h1 className="mt-2 text-2xl font-semibold text-[#202124]">Productivity tools need the Phase 5C database update</h1>
        <p className="mt-3 text-sm leading-6 text-[#5f6368]">{result.message}</p>
        <div className="mt-5 flex items-start gap-3 rounded-2xl bg-[#f8f9fa] p-4 text-sm leading-6 text-[#3c4043]">
          <BellRing className="mt-0.5 size-5 shrink-0 text-[#1967d2]" />
